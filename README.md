...
Use the Codex **Run** action. It calls `codex-run.ps1`, which resolves Bun and Bunx from `C:\Users\seant\.bun\bin`, starts Convex and Vite as separate processes, and avoids relying on Bun being picked up by `PATH`.
